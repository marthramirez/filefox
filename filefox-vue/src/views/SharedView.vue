...
export default {
  ...
  methods: {
    ...
    goToTeamSharedFolder(folder) {
      const encodedName = encodeURIComponent(folder.folder_name);
      this.$router.push(
        `/shared/folder/contents/${folder.id}/${encodedName}/${folder.permission}`
      );
    },
    ...
    async fetchFolders() {
      ...
      try {
        const response = await axios.get(
          `${process.env.VUE_APP_API_URL}/getFoldersSharedToUser/${user_id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
    ...
    async fetchDocuments() {
      ...
      try {
        const response = await axios.get(
          `${process.env.VUE_APP_API_URL}/getUserSharedFiles/${user_id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
